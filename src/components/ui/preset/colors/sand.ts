...
const semanticTokens = defineSemanticTokens.colors({
  ...
  a1: {
    value: { _light: "{colors.sand.light.a1}", _dark: "{colors.sand.dark.a1}" },
  },
  a2: {
    value: { _light: "{colors.sand.light.a2}", _dark: "{colors.sand.dark.a2}" },
  },
  a3: {
    value: { _light: "{colors.sand.light.a3}", _dark: "{colors.sand.dark.a3}" },
  },
  a4: {
    value: { _light: "{colors.sand.light.a4}", _dark: "{colors.sand.dark.a4}" },
  },
  a5: {
    value: { _light: "{colors.sand.light.a5}", _dark: "{colors.sand.dark.a5}" },
  },
  a6: {
    value: { _light: "{colors.sand.light.a6}", _dark: "{colors.sand.dark.a6}" },
  },
  a7: {
    value: { _light: "{colors.sand.light.a7}", _dark: "{colors.sand.dark.a7}" },
  },
  a8: {
    value: { _light: "{colors.sand.light.a8}", _dark: "{colors.sand.dark.a8}" },
  },
  a9: {
    value: { _light: "{colors.sand.light.a9}", _dark: "{colors.sand.dark.a9}" },
  },
  a10: {
    value: {
