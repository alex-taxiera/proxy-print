...
const semanticTokens = defineSemanticTokens.colors({
  ...
  a1: {
    value: {
      _light: "{colors.olive.light.a1}",
      _dark: "{colors.olive.dark.a1}",
    },
  },
  a2: {
    value: {
      _light: "{colors.olive.light.a2}",
      _dark: "{colors.olive.dark.a2}",
    },
  },
  a3: {
    value: {
      _light: "{colors.olive.light.a3}",
      _dark: "{colors.olive.dark.a3}",
    },
  },
  a4: {
    value: {
      _light: "{colors.olive.light.a4}",
      _dark: "{colors.olive.dark.a4}",
    },
  },
  a5: {
    value: {
      _light: "{colors.olive.light.a5}",
      _dark: "{colors.olive.dark.a5}",
    },
  },
  a6: {
    value: {
      _light: "{colors.olive.light.a6}",
      _dark: "{colors.olive.dark.a6}",
    },
  },
  a7: {
    value: {
      _light: "{colors.olive.light.a7}",
      _dark: "{colors.olive.dark.a7}",
    },
  },
  a8: {
    value: {
      _light: "{colors.olive.light.a8}",
      _dark: "{colors.olive.dark.a8}",
    },
  },
  a9: {
    value: {
      _light: "{colors.olive.light.a9}",
      _dark: "{colors.olive.dark.a9}",
    },
  },
  a10: {
    value: {
      _light: "{colors.olive.light.a10}",
      _dark: "{colors.olive.dark.a10}",
    },
  },
  a11: {
    value: {
      _light: "{colors.olive.light.a11}",
      _dark: "{colors.olive.dark.a11}",
    },
  },
  a12: {
    value: {
      _light: "{colors.olive.light.a12}",
      _dark: "{colors.olive.dark.a12}",
    },
  },
  default: {
    value: { _light: "{colors.olive.light.9}", _dark: "{colors.olive.dark.9}" },
