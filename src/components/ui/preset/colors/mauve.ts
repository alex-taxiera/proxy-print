...
const semanticTokens = defineSemanticTokens.colors({
  ...
  a1: {
    value: {
      _light: "{colors.mauve.light.a1}",
      _dark: "{colors.mauve.dark.a1}",
    },
  },
  a2: {
    value: {
      _light: "{colors.mauve.light.a2}",
      _dark: "{colors.mauve.dark.a2}",
    },
  },
  a3: {
    value: {
      _light: "{colors.mauve.light.a3}",
      _dark: "{colors.mauve.dark.a3}",
    },
  },
  a4: {
    value: {
      _light: "{colors.mauve.light.a4}",
      _dark: "{colors.mauve.dark.a4}",
    },
  },
  a5: {
    value: {
      _light: "{colors.mauve.light.a5}",
      _dark: "{colors.mauve.dark.a5}",
    },
  },
  a6: {
    value: {
      _light: "{colors.mauve.light.a6}",
      _dark: "{colors.mauve.dark.a6}",
    },
  },
  a7: {
    value: {
      _light: "{colors.mauve.light.a7}",
      _dark: "{colors.mauve.dark.a7}",
    },
  },
  a8: {
    value: {
      _light: "{colors.mauve.light.a8}",
      _dark: "{colors.mauve.dark.a8}",
    },
  },
  a9: {
    value: {
      _light: "{colors.mauve.light.a9}",
      _dark: "{colors.mauve.dark.a9}",
    },
  },
  a10: {
    value: {
      _light: "{colors.mauve.light.a10}",
      _dark: "{colors.mauve.dark.a10}",
    },
  },
  a11: {
    value: {
      _light: "{colors.mauve.light.a11}",
      _dark: "{colors.mauve.dark.a11}",
    },
  },
  a12: {
    value: {
      _light: "{colors.mauve.light.a12}",
      _dark: "{colors.mauve.dark.a12}",
    },
  },
  default: {
    value: { _light: "{colors.mauve.light.9}", _dark: "{colors.mauve.dark.9}" },
