...
export const colors = defineSemanticTokens.colors({
  bg: {
    ...
    warning: { value: { _light: '{colors.yellow.2}', _dark: '{colors.yellow.2}' } },
    success: { value: { _light: '{colors.green.2}', _dark: '{colors.green.2}' } },
  ...
  fg: {
    ...
    warning: { value: { _light: '{colors.yellow.10}', _dark: '{colors.yellow.10}' } },
    success: { value: { _light: '{colors.green.10}', _dark: '{colors.green.10}' } },
