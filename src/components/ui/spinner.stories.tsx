    ...
    <div style={{ position: 'relative', width: '400px', height: '300px' }}>
      ...
      <div style={{ 
        ...
        <div>
          ...
          <p>When loading, this content might be replaced with a spinner overlay.</p>
        </div>
...
export const Inline: Story = {
  render: () => (
    <div style={{ fontSize: '1rem', lineHeight: '1.5' }}>
      <p>
        This is a paragraph with an inline spinner: <Spinner size="sm" label="Loading" /> that shows loading state.
      </p>
      <p>
        You can also have multiple spinners: <Spinner size="xs" label="Processing" /> <Spinner size="xs" label="Loading" /> in the same line.
      </p>
    </div>
  ),
} 
