...
const IndicatorIcon = forwardRef<SVGSVGElement, Omit<FontAwesomeIconProps, 'icon'>>(
  (props, ref) => {  
...
const ItemIndicatorIcon = forwardRef<SVGSVGElement, Omit<FontAwesomeIconProps, 'icon'>>(
  (props, ref) => {
