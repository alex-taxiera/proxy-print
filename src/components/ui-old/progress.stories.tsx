...
export const LinearSizes: Story = {
  render: () => (
    ...
    >
      <div>
        <h3>Small Linear</h3>
        <Progress type="linear" size="sm" value={40}>
          Small Linear
        </Progress>
      </div>
      <div>
        <h3>Medium Linear</h3>
        <Progress type="linear" size="md" value={60}>
          Medium Linear
        </Progress>
      </div>
      <div>
        <h3>Large Linear</h3>
        <Progress type="linear" size="lg" value={80}>
          Large Linear
        </Progress>
      </div>
    </div>
...
export const CustomRange: Story = {
  render: () => (
    ...
    >
      ...
      <Progress value={750} min={0} max={1000}>
        750 out of 1000
      </Progress>
...
export const Accessibility: Story = {
  render: () => (
    ...
    >
      <Progress value={75} aria-label="File upload progress">
        Upload progress
      </Progress>
      <Progress
        type="circular"
