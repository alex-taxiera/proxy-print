...
const semanticTokens = defineSemanticTokens.colors({
  ...
  a1: {
    value: { _light: "{colors.sage.light.a1}", _dark: "{colors.sage.dark.a1}" },
  },
  a2: {
    value: { _light: "{colors.sage.light.a2}", _dark: "{colors.sage.dark.a2}" },
  },
  a3: {
    value: { _light: "{colors.sage.light.a3}", _dark: "{colors.sage.dark.a3}" },
  },
  a4: {
    value: { _light: "{colors.sage.light.a4}", _dark: "{colors.sage.dark.a4}" },
  },
  a5: {
    value: { _light: "{colors.sage.light.a5}", _dark: "{colors.sage.dark.a5}" },
  },
  a6: {
    value: { _light: "{colors.sage.light.a6}", _dark: "{colors.sage.dark.a6}" },
  },
  a7: {
    value: { _light: "{colors.sage.light.a7}", _dark: "{colors.sage.dark.a7}" },
  },
  a8: {
    value: { _light: "{colors.sage.light.a8}", _dark: "{colors.sage.dark.a8}" },
  },
  a9: {
    value: { _light: "{colors.sage.light.a9}", _dark: "{colors.sage.dark.a9}" },
  },
  a10: {
    value: {
      _light: "{colors.sage.light.a10}",
      _dark: "{colors.sage.dark.a10}",
    },
  },
  a11: {
    value: {
      _light: "{colors.sage.light.a11}",
      _dark: "{colors.sage.dark.a11}",
    },
  },
  a12: {
    value: {
      _light: "{colors.sage.light.a12}",
      _dark: "{colors.sage.dark.a12}",
    },
  },
  default: {
    value: { _light: "{colors.sage.light.9}", _dark: "{colors.sage.dark.9}" },
